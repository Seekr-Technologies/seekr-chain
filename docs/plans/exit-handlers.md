# Design: Exit Handlers (k8s + local backends)

**Status**: proposed
**Created**: 2026-08-18

Companion test matrix: [exit-handlers-test-matrix.md](exit-handlers-test-matrix.md).
...
The pure-jobsets ADR (`.hatchery/tasks/2026-04-21-pure-jobsets.md`) explicitly called out that dropping
...
Companion feature: exit-code-retries (`.hatchery/tasks/2026-08-18-exit-code-retries.md`, independent).
...
- exit-code-retries ADR (`.hatchery/tasks/2026-08-18-exit-code-retries.md`) — the companion feature.
- pure-jobsets ADR (`.hatchery/tasks/2026-04-21-pure-jobsets.md`) — where separate success/failure hooks
