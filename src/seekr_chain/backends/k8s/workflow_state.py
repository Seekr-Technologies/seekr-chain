...
def _jobset_metadata_from_object(jobset: Optional[dict]) -> _JobMetadata:
    ...
    status, dt_end = controller_jobset_status_and_completion(jobset)
...
def build_workflow_state(
    ...
    """
    meta = _jobset_metadata_from_object(controller_jobset)
...
def get_workflow_state(k8s_custom, k8s_v1, namespace: str, workflow_id: str) -> WorkflowState:
    ...
    return build_workflow_state(workflow_id, controller_jobset, jobsets, pods)


def get_workflow_job_status(
    k8s_custom, namespace: str, workflow_id: str
    ...
    return controller_jobset_status_and_completion(jobset)
